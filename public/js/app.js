...
var loadIcon = function loadIcon(input) {
...
var hideAllContextMenus = function hideAllContextMenus() {
  document.querySelectorAll('.js-report-menu').forEach(function (element) {
...
var updateContextMenuListeners = function updateContextMenuListeners() {
  ...
  document.querySelectorAll('.js-report-options').forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.stopPropagation();
      var reportItem = e.currentTarget.parentNode;
      var contextMenu = reportItem.querySelector('.js-report-menu');
      hideAllContextMenus();
...
document.querySelector('.js-toggle-reports').addEventListener('click', function () {
  var makeActive = document.querySelectorAll('.js-toggle-reports-icon, .js-reports');
...
/***/ 0:
/*!***************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/app.scss ./resources/css/fonts.css ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
